'''
    @name:      train_ppo.py
    @brief:     Starts a ppo2-training process. It is expected that move_base_rgring, simulation etc is started.(roslaunch rl_setup_bringup setup.launch)
