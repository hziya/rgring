...
class Evaluation():
    ...
    def __init__(self, state_collector, ns, robot_radius = 0,robot_width = 0.58, robot_height = 0.89):
        ...
        self.__global_plan_sub = rospy.Subscriber("%s/move_base_rgring/NavfnROS/plan"%self.__NS, Path, self.__path_callback, queue_size=1)
        # self.__path_sub = rospy.Subscriber("%s/move_base_rgring/GlobalPlanner/plan" % self.__NS, Path, self.__path_callback,  queue_size=1)
