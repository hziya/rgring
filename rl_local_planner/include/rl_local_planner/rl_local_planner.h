 ...
 * @brief	 	  Connector of move_base_rgring and rl_agent using RL library. Forwards action of rl_agent
 * 				    to move_base_rgring each time step.
...
namespace rl_local_planner {
   ...
   * to move_base_rgring over this class.
   */
